...
resourcegroup_name = 'qtt'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'qtt'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
print('Created entry for Car dealer...\n')

#populate with coffee
coffee = Entity()
